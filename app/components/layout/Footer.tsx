...
export default function Footer() {
  return (
    <footer className="w-90 rounded-md z-100 text-on-surface  bottom-0 fixed h-16 flex justify-evenly items-center bg-background/60 backdrop-blur-lg border border-outline-variant">
      <Link
        href="/"
